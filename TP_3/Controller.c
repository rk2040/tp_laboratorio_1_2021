    ...
    if(pArrayListEmployee != NULL)
    {
                            ...
                            "\nError, ingrese un Id valido\n",0,5000,4))
        {
            ...
            else
            {
                ...
                confirmar = opcionConfirmar("Seguro que quiere realizar la Baja? s/n ", "Error. Seguro que quiere realizar la Baja? s/n ");
