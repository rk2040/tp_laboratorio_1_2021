...
int main()
{
    ...
    do
    {
        ...
        case 1:
            if(!flagBinario)
            {
                printf("Ya esta trabajando con el archivo en binario, debe guardarlo primero!\n");
        ...
        case 2:
            if(!flagTexto)
            {
                printf("Esta trabajando con el archivo en texto, debe guardarlo primero!\n");
            ...
            else
            {
                if(!flagBinario)
                {
                    printf("Ya abrio el archivo en modo binario!\n");
                }
                else
                {
