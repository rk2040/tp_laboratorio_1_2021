...
static int addNode(LinkedList* this, int nodeIndex,void* pElement);     // Agrego un Nodo
...
LinkedList* ll_newLinkedList(void)
{
    ...
    this = (LinkedList*) malloc(sizeof(LinkedList));    // consigo, pido espacio en memoria
 ...
 * \return int Retorna  (-1) Error: si el puntero a la lista es NULL o (si el indice es menor a 0 o mayor al len de la lista)   //Linea 111
...
void* ll_get(LinkedList* this, int index)
{
    ...
    aux = getNode(this, index);     // no valido antes porque getNode ya tiene las validaciones
